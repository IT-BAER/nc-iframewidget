"use strict";
(self["webpackChunkiframewidget"] = self["webpackChunkiframewidget"] || []).push([["node_modules_nextcloud_dialogs_dist_legacy_mjs"],{
...
/* harmony import */ var _chunks_index_CRno7JSe_mjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./chunks/index-CRno7JSe.mjs */ "./node_modules/@nextcloud/dialogs/dist/chunks/index-CRno7JSe.mjs");
...
/* harmony import */ var _chunks_DialogBase_aHPYSWdD_mjs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./chunks/DialogBase-aHPYSWdD.mjs */ "./node_modules/@nextcloud/dialogs/dist/chunks/DialogBase-aHPYSWdD.mjs");
...
async function z(v, i, a = !1, u, C, r = _chunks_index_CRno7JSe_mjs__WEBPACK_IMPORTED_MODULE_1__.a.Choose, h, m) {
  const y = (e, c) => {
    const n = (t) => {
  ...
  let b;
  r === _chunks_index_CRno7JSe_mjs__WEBPACK_IMPORTED_MODULE_1__.a.Custom ? (b = [], (m.buttons || []).forEach((e) => {
    b.push({
      callback: y(i, e.type),
      label: e.text,
    ...
    return r === _chunks_index_CRno7JSe_mjs__WEBPACK_IMPORTED_MODULE_1__.a.Choose && l.push({
      callback: y(i, _chunks_index_CRno7JSe_mjs__WEBPACK_IMPORTED_MODULE_1__.a.Choose),
      label: p && !a ? (0,_chunks_index_CRno7JSe_mjs__WEBPACK_IMPORTED_MODULE_1__.t)("Choose {file}", { file: p }) : (0,_chunks_index_CRno7JSe_mjs__WEBPACK_IMPORTED_MODULE_1__.t)("Choose"),
      type: "primary"
    }), (r === _chunks_index_CRno7JSe_mjs__WEBPACK_IMPORTED_MODULE_1__.a.CopyMove || r === _chunks_index_CRno7JSe_mjs__WEBPACK_IMPORTED_MODULE_1__.a.Copy) && l.push({
      callback: y(i, _chunks_index_CRno7JSe_mjs__WEBPACK_IMPORTED_MODULE_1__.a.Copy),
      label: d ? (0,_chunks_index_CRno7JSe_mjs__WEBPACK_IMPORTED_MODULE_1__.t)("Copy to {target}", { target: d }) : (0,_chunks_index_CRno7JSe_mjs__WEBPACK_IMPORTED_MODULE_1__.t)("Copy"),
      type: "primary",
      icon: _mdi_svg_svg_folder_multiple_svg_raw__WEBPACK_IMPORTED_MODULE_4__
    }), (r === _chunks_index_CRno7JSe_mjs__WEBPACK_IMPORTED_MODULE_1__.a.Move || r === _chunks_index_CRno7JSe_mjs__WEBPACK_IMPORTED_MODULE_1__.a.CopyMove) && l.push({
      callback: y(i, _chunks_index_CRno7JSe_mjs__WEBPACK_IMPORTED_MODULE_1__.a.Move),
      label: d ? (0,_chunks_index_CRno7JSe_mjs__WEBPACK_IMPORTED_MODULE_1__.t)("Move to {target}", { target: d }) : (0,_chunks_index_CRno7JSe_mjs__WEBPACK_IMPORTED_MODULE_1__.t)("Move"),
      type: r === _chunks_index_CRno7JSe_mjs__WEBPACK_IMPORTED_MODULE_1__.a.Move ? "primary" : "secondary",
  ...
  M(_chunks_index_CRno7JSe_mjs__WEBPACK_IMPORTED_MODULE_1__.c, {
    ...g,
    name: v,
    buttons: b,
    multiselect: a,
...
async function H(v, i, a, u) {
  M(_chunks_DialogBase_aHPYSWdD_mjs__WEBPACK_IMPORTED_MODULE_3__.D, { name: i, message: v, buttons: [
    {
      label: "No",
...
//# sourceMappingURL=node_modules_nextcloud_dialogs_dist_legacy_mjs.js.map